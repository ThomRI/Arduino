...
QT_MOC_LITERAL(3, 26, 12), // "const float*"
QT_MOC_LITERAL(4, 39, 4), // "push"
QT_MOC_LITERAL(5, 44, 8) // "received"

    },
    "ArduinoInterfacer\0pushed\0\0const float*\0"
    "push\0received"
};
...
void ArduinoInterfacer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pushed((*reinterpret_cast< const float*(*)>(_a[1]))); break;
        ...
        {
            typedef void (ArduinoInterfacer::*_t)(const float * );
...
// SIGNAL 0
void ArduinoInterfacer::pushed(const float * _t1)
{
